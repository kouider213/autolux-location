...
export default function Home({ cars, reviews }) {
  ...
  return (
    <>
      <Head>
        <title>AutoLux Location — Location de Véhicules Premium</title>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
          ...
          <div className="relative z-10 text-center max-w-5xl mx-auto px-4">
            ...
            <p className="text-white/50 text-lg md:text-xl max-w-2xl mx-auto mb-12 leading-relaxed">
              Large sélection de véhicules pour tous vos besoins.
              Citadines, SUV, utilitaires et voitures premium.
              Sans caution. Sans stress.
            </p>
              ...
              {[
                {
                  icon: '🛡️',
                  title: 'Sans caution',
                  desc: 'Nous faisons confiance à nos clients. Aucune caution ne vous sera demandée.',
                },
                {
                  icon: '⚡',
                ...
                },
                {
                  icon: '🚗',
                  title: 'Flotte variée',
                  desc: 'Citadines économiques, SUV familiaux, utilitaires 9 places. Un véhicule pour chaque besoin.',
                },
              ].map((item) => (
        ...
        <footer className="border-t border-white/5 py-12 px-4">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-white">AutoLux Location</span>
            </div>
            ...
            <span className="text-white/20 text-sm">© 2024 AutoLux Location</span>
          </div>
        </footer>
      </div>
    </>
