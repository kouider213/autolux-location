...
import {
  ...
  BarChart3, LogOut, Globe, Menu, Bell, Building2, Tag, Settings, FileText, HelpCircle, Newspaper, Package, CalendarRange, Mail, Wallet, Ship, UserPlus,
} from 'lucide-react';
...
const NAV = [
  ...
  { href: '/admin/leads',       label: 'Leads / Demandes',   icon: UserPlus },
