...
import { ClipboardList, CalendarCheck, FileText, Wallet, PackageCheck, CheckCircle2, KeyRound, Handshake, XCircle, Search } from 'lucide-react';
...
export const DOSSIER_FLOWS = {
  ...
  immo: [
    ...
    { key: 'CONTRACT',  icon: Handshake,     fr: 'Contrat',            ar: 'العقد',             en: 'Contract' },
