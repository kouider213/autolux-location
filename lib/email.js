...
const BOOKING_STATUS = {
  PENDING:   { label: 'En attente de confirmation', line: "Nous avons bien reçu votre demande. Notre équipe la confirme très vite." },
  ACCEPTED:  { label: 'Confirmée ✅', line: 'Bonne nouvelle, votre réservation est confirmée !' },
  CONFIRMED: { label: 'Confirmée ✅', line: 'Bonne nouvelle, votre réservation est confirmée !' },
  ACTIVE:    { label: 'En cours 🚗', line: 'Votre location est en cours. Bonne route !' },
  COMPLETED: { label: 'Terminée', line: 'Votre location est terminée. Merci de votre confiance 🙏' },
  REJECTED:  { label: 'Non disponible', line: "Nous ne sommes pas disponibles sur ces dates. Contactez-nous pour d'autres dates." },
  CANCELLED: { label: 'Annulée', line: 'Votre réservation a été annulée. Une question ? Écrivez-nous.' },
};
